...
** My Teams
** File description:
** Provided logging client header file
*/
...
/*!
    ...
    \param timestamp an unsigned integer corresponding to the timestamp of the
            message.
    \param message a character pointer corresponding to the message.
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
...
/*!
    \param channel_id an unsigned integer corresponding to the WRONG channel
            identifier
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
*/
...
/*!
    \param thread_id an unsigned integer corresponding to the WRONG thread
            identifier
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
*/
...
/*!
    \param user_id an unsigned integer corresponding to the WRONG user
            identifier
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
*/
...
/*!
    \param user_id a character pointer corresponding to the universally unique
            id assigned to the user who subscribed;
    \param team_id a character pointer corresponding to the universally unique
            id assigned to the team the user subscribed to.
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
*/
...
/*!
    \param user_id a character pointer corresponding to the universally unique
            id assigned to the user who unsubscribed;
    \param team_id a character pointer corresponding to the universally unique
            id assigned to the team the user unsubscribed from.
    \return On success, 1 is returned. On error, -1 is returned and errno is
            set appropriately
*/
